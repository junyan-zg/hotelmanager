/**   
* @Title: RBookroomDetailDaoImpl.java 
...
/** 
 * @ClassName: RBookroomDetailDaoImpl 
 * @Description: TODO 
 * @author zjy
 * @date 2016年4月15日 上午6:15:2 
 *  
 */
@Repository("rBookroomDetailDao")
public class RBookroomDetailDaoImpl extends BaseDaoImpl<RBookroomDetail> implements RBookroomDetailDao{

...
/** 
 * @ClassName: RRoomGroupDaoImpl 
 * @Description: TODO 
 * @author zjy
 * @date 2016年4月15日 上午6:15:2 
 *  
 */
@Repository("rRoomGroupDao")
public class RRoomGroupDaoImpl extends BaseDaoImpl<RRoomGroup> implements RRoomGroupDao{
